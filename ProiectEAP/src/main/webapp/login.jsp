...
<div class="login-box">
    ...
    <form name='f1' action=''>
        ...
        <input type='button' name='Create new account...' value='Create new account...' onclick='return chkAndSubmit(this)'/>
...
<script>function chkAndSubmit(ele) {
    if(ele.getAttribute('name') == 'Create new account...') {
        document.f1.setAttribute("action","/register")
        document.f1.submit();
    }
}</script>